...
export const STATUSREQUEST_TRANSLATION = {
  [STATUSREQUEST.PENDING]: "Đang chờ",
  [STATUSREQUEST.APPROVED]: "Chấp thuận",
  [STATUSREQUEST.CANCELLED]: "Hoàn thành",
  [STATUSREQUEST.REJECTED]: "Từ chối",
};
enum REQUESTSTATUS {
  PENDING = "PENDING",
  APPROVED = "APPROVED",
